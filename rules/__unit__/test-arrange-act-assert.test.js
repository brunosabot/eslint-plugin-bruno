...
describe("Given the test-arrange-act-assert rule", () => {
  describe("When the code follows the Arrange/Act/Assert structure", () => {
  ...
  describe("When the code violates the Arrange/Act/Assert structure", () => {
    it("Then it should fail for a test missing Arrange", () => {
      // Arrange
      const invalidCode = `
        it(\"Then it should do something\", () => {
          // Assert
    ...
    it("Then it should fail for a test missing Assert", () => {
      // Arrange
      const invalidCode = `
        it(\"Then it should do something\", () => {
          // Arrange
    ...
    it("Then it should fail for a test missing both Arrange and Assert", () => {
      // Arrange
      const invalidCode = `
        it(\"Then it should do something\", () => {
          // Act
    ...
    it("Then it should fail for an empty test", () => {
      // Arrange
      const invalidCode = `
        it(\"Then it should do something\", () => {});
      `;
